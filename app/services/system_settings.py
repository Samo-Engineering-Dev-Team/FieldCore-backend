...
class _SystemSettingsService:
    ...
    def get_settings_by_category(
        self, category: str, session: Session
    ...
    def update_setting(
        self, key: str, data: SystemSettingUpdate, session: Session
    ) -> SystemSettingResponse:
    ...
    def bulk_update_settings(
        self, data: SystemSettingsBulkUpdate, session: Session
    ) -> SystemSettingsResponse:
    ...
    def create_setting(
        self, data: SystemSettingCreate, session: Session
    ) -> SystemSettingResponse:
    ...
    def get_debug_config(self, session: Session) -> DebugConfig:
        ...
        return DebugConfig(
            ...
            enable_request_logging=self.get_setting(
                "enable_request_logging", session, False
            ),
            enable_sql_logging=self.get_setting("enable_sql_logging", session, False),
            enable_performance_headers=self.get_setting(
...
SystemSettingsService = Annotated[
    _SystemSettingsService, Depends(get_system_settings_service)
]
